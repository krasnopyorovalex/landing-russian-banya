...
}(window.Zepto||window.jQuery,window,document),jQuery(document).ready(function(){function t(){if(!$("#map-yandex").length)return!1;var t=new ymaps.Map("map-yandex",{center:[44.581759,33.484082],zoom:17,controls:["zoomControl","fullscreenControl"]}),e=new ymaps.GeoObject({geometry:{type:"Point",coordinates:[44.581759,33.484082]}});t.geoObjects.add(e),t.layers.get(0).get(0)}function e(t,e){var i=document.createElement("script");i.readyState?i.onreadystatechange=function(){"loaded"!==i.readyState&&"complete"!==i.readyState||(i.onreadystatechange=null,e())}:i.onload=function(){e()},i.src=t,document.getElementsByTagName("head")[0].appendChild(i)}[].forEach.call(document.querySelectorAll("img[data-src]"),function(t){t.setAttribute("src",t.getAttribute("data-src")),t.onload=function(){t.removeAttribute("data-src")}});var i=jQuery(".burger-mob");if(i.length){var s=jQuery(".mobile__menu"),n=jQuery(".close-menu-btn");i.on("click",function(){return s.addClass("is__opened")&&s.fadeIn("fast")}),n.on("click",function(){return s.removeClass("is__opened")&&s.fadeOut()}),s.on("click",".has__child > span",function(t){t.preventDefault();var e=jQuery(this);return e.next("ul").is(":hidden")?e.next("ul").slideDown():e.next("ul").slideUp(),!1})}var o=jQuery("#nav__menu");if(o.length){var a=jQuery("header"),r=a.height();jQuery(window).scroll(function(){return window.pageYOffset>=r?!o.hasClass("is__sticky")&&o.hide().addClass("is__sticky").fadeIn():o.removeClass("is__sticky")})}var h=jQuery("form input.phone__mask");h.length&&h.mask("+0 (000) 000-00-00",{placeholder:"+_ (___) ___-__-__"});var l=jQuery(".default__slider");l.length&&l.owlCarousel({loop:!1,margin:8,nav:!0,dots:!1,items:4,navText:['<i class="prev-arrow"></i>','<i class="next-arrow"></i>'],responsive:{0:{items:1},480:{items:1},768:{items:4}}});var c=jQuery(".faq");c.length&&c.on("click","li .q",function(){var t=jQuery(this),e=t.parent("li");return c.find(".a").hide(),e.hasClass("active")?c.find("li").removeClass("active"):c.find("li").removeClass("active")&&t.next(".a").fadeIn("slow")&&e.addClass("active")});var d=jQuery("#nav__menu,.mobile__menu,.footer__menu");d.length&&d.on("click","li > a",function(t){t.preventDefault();var e=jQuery(this),i=e.attr("href");return jQuery(".mobile__menu").removeClass("is__opened").fadeOut(),jQuery.scrollTo(jQuery(i),750,{offset:{top:-80}})});var u=jQuery(".view__detail-link"),p=jQuery("#view__detail-popup"),g=jQuery(".popup__show-bg");u.length&&(u.on("click",function(){return jQuery.ajax({type:"POST",dataType:"html",url:jQuery(this).attr("data-link"),success:function(t){return p.fadeIn(),g.show(),p.html(t)&&startCarouselDM()}})}),p.on("click",".close",function(){return p.fadeOut("slow")&&g.fadeOut()})),jQuery(".loader, .loader__bg").delay(250).fadeOut("250",function(){return jQuery(this).fadeOut()}),lightbox.option({albumLabel:"Изображение %1 из %2"});var m=jQuery(".slider__about-us");if(m.length){m.owlCarousel({loop:!1,margin:5,nav:!0,dots:!1,items:1,navText:["",""]});var f=jQuery(".slider__about-us-nav");f.on("click","div[data-target]",function(){var t=jQuery(this),e=parseInt(t.attr("data-target"));return f.find("div[data-target]").removeClass("active"),t.addClass("active"),m.trigger("to.owl.carousel",e-1)})}var v=jQuery(".call__popup");v.length&&(v.on("click",function(t){t.preventDefault();var e=jQuery(this);return jQuery("#"+e.attr("data-target")).fadeIn()&&g.show()}),jQuery(".popup").on("click",".close",function(){return jQuery(this).closest(".popup").fadeOut("slow")&&g.fadeOut()}));var y={element:!1,setElement:function(t){return this.element=t},notify:function(t){return this.element||this.setElement(jQuery(".notify")),this.element.html("<div>"+t+"</div>")&&this.element.fadeIn().delay(7e3).fadeOut()}};formHandler("#form__callback",y),formHandler("#form__consultation",y);var _=document.querySelectorAll(".youtube-box"),w=_.length;if(w)for(var b=0;b<w;b++)!function(t){var e="https://img.youtube.com/vi/"+_[t].dataset.embed+"/sddefault.jpg",i=new Image;i.src=e,i.addEventListener("load",function(){return _[t].appendChild(i)}()),_[t].addEventListener("click",function(){var t=document.createElement("iframe");t.setAttribute("frameborder","0"),t.setAttribute("allowfullscreen",""),t.setAttribute("allow","accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture"),t.setAttribute("src","https://www.youtube.com/embed/"+this.dataset.embed+"?rel=0&showinfo=0&autoplay=1"),this.innerHTML="",this.appendChild(t)})}(b);var x=!1,C=$(document).height()/3;!function(){jQuery(window).scroll(function(){!x&&window.pageYOffset>=C&&(x=!0,e("https://api-maps.yandex.ru/2.1/?lang=ru_RU&amp;loadByRequire=1",function(){ymaps.load(t)}))})}()}),jQuery.ajaxSetup({headers:{"X-CSRF-TOKEN":jQuery('meta[name="csrf-token"]').attr("content")}}),jQuery(document).ajaxError(function(){return jQuery("form .submit").removeClass("is__sent")&&jQuery(".notify").html("<div>Произошла ошибка =(</div>").fadeIn().delay(3e3).fadeOut()});
