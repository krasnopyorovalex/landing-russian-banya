...
}(window.Zepto||window.jQuery,window,document),jQuery(document).ready(function(){[].forEach.call(document.querySelectorAll("img[data-src]"),function(t){t.setAttribute("src",t.getAttribute("data-src")),t.onload=function(){t.removeAttribute("data-src")}});var t=jQuery(".burger-mob");if(t.length){var e=jQuery(".mobile__menu"),i=jQuery(".close-menu-btn");t.on("click",function(){return e.addClass("is__opened")&&e.fadeIn("fast")}),i.on("click",function(){return e.removeClass("is__opened")&&e.fadeOut()}),e.on("click",".has__child > span",function(t){t.preventDefault();var e=jQuery(this);return e.next("ul").is(":hidden")?e.next("ul").slideDown():e.next("ul").slideUp(),!1})}var s=jQuery("#nav__menu");if(s.length){var n=jQuery("header"),o=n.height();jQuery(window).scroll(function(){return window.pageYOffset>=o?!s.hasClass("is__sticky")&&s.hide().addClass("is__sticky").fadeIn():s.removeClass("is__sticky")})}var a=jQuery("form input.phone__mask");a.length&&a.mask("+0 (000) 000-00-00",{placeholder:"+_ (___) ___-__-__"});var r=jQuery(".default__slider");r.length&&r.owlCarousel({loop:!1,margin:8,nav:!0,dots:!1,items:4,navText:['<i class="prev-arrow"></i>','<i class="next-arrow"></i>'],responsive:{0:{items:1},480:{items:1},768:{items:4}}});var h=jQuery(".faq");h.length&&h.on("click","li .q",function(){var t=jQuery(this),e=t.parent("li");return h.find(".a").hide(),e.hasClass("active")?h.find("li").removeClass("active"):h.find("li").removeClass("active")&&t.next(".a").fadeIn("slow")&&e.addClass("active")});var l=jQuery("#nav__menu,.mobile__menu,.footer__menu");l.length&&l.on("click","li > a",function(t){t.preventDefault();var e=jQuery(this),i=e.attr("href");return jQuery(".mobile__menu").removeClass("is__opened").fadeOut(),jQuery.scrollTo(jQuery(i),750,{offset:{top:-80}})});var c=jQuery(".view__detail-link"),d=jQuery("#view__detail-popup"),u=jQuery(".popup__show-bg");c.length&&(c.on("click",function(){return jQuery.ajax({type:"POST",dataType:"html",url:jQuery(this).attr("data-link"),success:function(t){return d.fadeIn(),u.show(),d.html(t)&&startCarouselDM()}})}),d.on("click",".close",function(){return d.fadeOut("slow")&&u.fadeOut()})),jQuery(".loader, .loader__bg").delay(250).fadeOut("250",function(){return jQuery(this).fadeOut()}),lightbox.option({albumLabel:"Изображение %1 из %2"});var p=jQuery(".slider__about-us");if(p.length){p.owlCarousel({loop:!1,margin:5,nav:!0,dots:!1,items:1,navText:["",""]});var g=jQuery(".slider__about-us-nav");g.on("click","div[data-target]",function(){var t=jQuery(this),e=parseInt(t.attr("data-target"));return g.find("div[data-target]").removeClass("active"),t.addClass("active"),p.trigger("to.owl.carousel",e-1)})}var m=jQuery(".call__popup");m.length&&(m.on("click",function(t){t.preventDefault();var e=jQuery(this);return jQuery("#"+e.attr("data-target")).fadeIn()&&u.show()}),jQuery(".popup").on("click",".close",function(){return jQuery(this).closest(".popup").fadeOut("slow")&&u.fadeOut()}));var f={element:!1,setElement:function(t){return this.element=t},notify:function(t){return this.element||this.setElement(jQuery(".notify")),this.element.html("<div>"+t+"</div>")&&this.element.fadeIn().delay(7e3).fadeOut()}};formHandler("#form__callback",f),formHandler("#form__consultation",f),formHandler("#form__calculate",f);var v=document.querySelectorAll(".youtube-box"),y=v.length;if(y)for(var _=0;_<y;_++)!function(t){var e="https://img.youtube.com/vi/"+v[t].dataset.embed+"/sddefault.jpg",i=new Image;i.src=e,i.addEventListener("load",function(){return v[t].appendChild(i)}()),v[t].addEventListener("click",function(){var t=document.createElement("iframe");t.setAttribute("frameborder","0"),t.setAttribute("allowfullscreen",""),t.setAttribute("allow","accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture"),t.setAttribute("src","https://www.youtube.com/embed/"+this.dataset.embed+"?rel=0&showinfo=0&autoplay=1"),this.innerHTML="",this.appendChild(t)})}(_)}),jQuery.ajaxSetup({headers:{"X-CSRF-TOKEN":jQuery('meta[name="csrf-token"]').attr("content")}}),jQuery(document).ajaxError(function(){return jQuery("form .submit").removeClass("is__sent")&&jQuery(".notify").html("<div>Произошла ошибка =(</div>").fadeIn().delay(3e3).fadeOut()});
